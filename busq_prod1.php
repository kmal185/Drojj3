...
<div class="wrapper row3">
  ...
  <section id="services">
      <div class="sectiontitle">
        ...
        <h6 class="heading">Buscar Producto</h6>
        </article>
        </li>
        <div id="contenido">
    ...
    <br>
    <form action="resultado.php" method="GET" style="border-collapse: separate; border-spacing: 10px 5px;">
      
    <br>
    <label>Producto: &nbsp;&nbsp;&nbsp;<input type="text" id="nombre" name="nombre"><br></label>
    
    <br>
    <label>Laboratorio: <input type="text" id="laboratorio" name="laboratorio" ><br></label>
