...
<br><div id="contenido">
<center><a href="busq_prov.php"> <button type="button" class="btn btn-inf">Buscar </button>
 <a href="Gestion_proveedores.php"> <button type="button" class="btn btn-inf">Nuevo</button></a></a>
 <a href="excelprov.php"> <button type="button" class="btn btn-inf">Excel <i class="fa fa-table" aria-hidden="true"></i></button></a>
 <a href="reportepdfprov.php"><button type="button" class="btn btn-inf">PDF <i class="fa fa-table" aria-hidden="true"></i></button></a></center>
...
$consulta=ConsultarProducto3($_GET['identificacion'],$_GET['proveedor']);

function ConsultarProducto3( $identificacion,$proveedor )
{
  include "conexion2.php";
$sentencia="SELECT * FROM proveedor WHERE identificacion ='".$identificacion."' OR proveedor ='".$proveedor."'";
