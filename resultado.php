...
<br><div id="contenido">
 <center><a href="busq_prod1.php"> <button type="button" class="btn btn-inf">Buscar </button>
 <a href="Gestion_productos.php"> <button type="button" class="btn btn-inf">Nuevo</button>  
 <a href="excel.php"> <button type="button" class="btn btn-inf">Excel <i class="fa fa-table" aria-hidden="true"></i></button></a>
 <a href="reportepdf.php"><button type="button" class="btn btn-inf">PDF <i class="fa fa-table" aria-hidden="true"></i></button></a></center>
...
<?php
$consulta=ConsultarProducto2($_GET['nombre'],$_GET['laboratorio']);

function ConsultarProducto2( $nombre,$laboratorio )
{
    include 'conexion2.php';
    $sentencia="SELECT * FROM productos WHERE nombre ='".$nombre."' OR laboratorio ='".$laboratorio."'";
    ...
    while($fila=$resultado->fetch_assoc())
    {
        ...
        echo "<td>"; echo $fila['laboratorio']; echo "</td>";
        echo " <td><a href='modif_prod1.php?id_productos=".$fila['id_productos']."'> <button type='button'class='btn btn-success'>Modificar</button></a></td>";
        echo " <td><a href='eliminar_prod.php?id_productos=".$fila['id_productos']."'> <button type='button'class='btn btn-danger'>Eliminar</button></a></td>";
        echo "</tr>";
    }
  }
?>
